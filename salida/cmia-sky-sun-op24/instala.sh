...
echo ""
echo "Script para instalar la instancia CMIA-SKY-SUN-OP24"
echo ""
...
mkdir -p /siscom/instancias/CMIA-SKY-SUN-OP24/log/
mkdir -p /siscom/instancias/CMIA-SKY-SUN-OP24/db/
...
cp cmia-sky-sun-op24.ini /etc/supervisord.d
