...
echo ""
echo "Script para instalar la instancia CMIA-SKY-SUN-OP6"
echo ""
...
mkdir -p /siscom/instancias/CMIA-SKY-SUN-OP6/log/
mkdir -p /siscom/instancias/CMIA-SKY-SUN-OP6/db/
...
cp cmia-sky-sun-op6.ini /etc/supervisord.d
