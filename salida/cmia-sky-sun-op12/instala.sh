...
echo ""
echo "Script para instalar la instancia CMIA-SKY-SUN-OP12"
echo ""
...
mkdir -p /siscom/instancias/CMIA-SKY-SUN-OP12/log/
mkdir -p /siscom/instancias/CMIA-SKY-SUN-OP12/db/
...
cp cmia-sky-sun-op12.ini /etc/supervisord.d
