...
% if data['usar_kafka'] == 'si':
    ...
    <modulo>
        ...
        <parametros>
            ...
            <parametro nombre="servidoresKafka" valor="10.190.5.172:9092,10.190.5.173:9092" />
            ...
            <parametro nombre="servidoresZookeeper" valor="10.190.5.174:2181" />
    ...
    <modulo>
	    ...
	    <!-- indica si se han de filtrar las notificaciones MobilEye -->
            ...
            <parametro nombre="procesarRespuestaComando" valor="no" />
